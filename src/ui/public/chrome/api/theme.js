...
chrome.setCustomizedNavBackground = function(cssBackground){
  internals.customizedNavBackground = cssBackground;
  return chrome;
};

  chrome.setNavFontColor = function(cssFontcolor){
    internals.navFontColor = cssFontcolor;
    return chrome;
  };
  ...
  chrome.getNavFontColor = function(){
    return internals.navFontColor;
  };

  chrome.getCustomizedNavBackground = function(){
    return internals.customizedNavBackground;
  };
